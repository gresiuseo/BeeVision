...
object HistoryStorage {
    ...
    private val HISTORY_KEY =
        stringPreferencesKey("history")
            ...
            if (item is JSONObject) {
                ...
                list.add(
                    ScanResult(
                        ...
                        totalCells =
                            item.optInt("totalCells"),

                        broodCells =
                            item.optInt("broodCells"),

                        honeyCells =
                            item.optInt("honeyCells"),

                        pollenCells =
                            item.optInt("pollenCells"),

                        emptyCells =
                            item.optInt("emptyCells"),
